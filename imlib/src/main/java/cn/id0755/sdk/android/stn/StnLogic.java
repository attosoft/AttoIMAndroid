 ...
 */
package cn.id0755.sdk.android.stn;
...
public class StnLogic {
     ...
     */
    public static void setLonglinkSvrAddr(final String host, final int[] ports, final String debugIP) {
     ...
     */
    public static void setShortlinkSvrAddr(final int port, final String debugIP){

    }

    public static void setShortlinkSvrAddr(final int port) {
     ...
     * @param ip    该域名对应的IP
     */
    public static void setDebugIP(final String host, final String ip){}

    //async call
    public static void startTask(final Task task){}

    //sync call
    public static void stopTask(final int taskID){}

    //sync call
    public static boolean hasTask(final int taskID){
        return false;
    }
     ...
     * @param ips   域名对应的IP列表
     */
    public static void setBackupIPs(final String host, final String[] ips){}
     ...
     */
    public static void setSignallingStrategy(long period, long keepTime){}

    /**
     * 发送一个信令保活包(如果有必要)
     */
    public static void keepSignalling(){}

    /**
     * 停止信令保活
     */
    public static void stopSignalling(){}
     ...
     * @return
     */
    private static ArrayList<String> getLoadLibraries(){
        return null;
    }
