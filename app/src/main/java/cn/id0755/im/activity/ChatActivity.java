        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.send:
                    ...
                    SendMsgTask msgTask = new SendMsgTask();
                    msgTask.setAccessToken("")
                            .setFrom("10086")
                            .setTo("10086")
                            .setText(mEditInput.getText().toString())
                            .setTopic("10086")
                            .setListener(new ITaskListener<Chat.SendMessageResponse>() {
                                @Override
                                public void onResp(Chat.SendMessageResponse resp) {
                                    Log.d(TAG,"onResp : " + resp.getText());
                                }
                    ...
                    MessageServiceManager.getInstance().send(msgTask);
